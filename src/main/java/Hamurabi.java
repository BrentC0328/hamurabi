...
public class Hamurabi {
	...
	private void newYear() {
		...
		do {
			...
			if (temp < 0)
				epicFail(0);
			if (temp > acres)
				System.out.println("hammurabi.src.main.java.HAMURABI:  THINK AGAIN. YOU OWN ONLY " + acres + " ACRES. NOW THEN,");
		} while (temp > acres);
		stores += temp * landPrice;
		acres -= temp;
		do {
	...
	private static String report() {
		String answer = "\nhammurabi.src.main.java.HAMURABI:  I BEG TO REPORT TO YOU,\n" +
	...
	private static void epicFail(int x) {
		String reason = "";
		switch (x) {
		case 0: reason = "hammurabi.src.main.java.HAMURABI:  I CANNOT DO WHAT YOU WISH.\n" +
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("\t\t\t\thammurabi.src.main.java.HAMURABI\n\t       CREATIVE COMPUTING MORRISTOWN, NEW JERSEY\n\n" +
